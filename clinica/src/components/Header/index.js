      ...
      <nav className={styles.nav}>
        <ul className={`${styles.menu} ${menuOpen ? styles.active : ""}`}>
          ...
          <li className={styles.itemMenu}>
            ...
            <ul className={styles.subMenu}>
              <li className={styles.itemSubMenu}>
                <a className={styles.linkSubmenu} href="/listarMedico">
                  Listar
                </a>
              </li>
              <li className={styles.itemSubMenu}>
          ...
          <li className={styles.itemMenu}>
            ...
            <ul className={styles.subMenu}>
              <li className={styles.itemSubMenu}>
                <a className={styles.linkSubmenu} href="/listarPaciente">
                  Listar
                </a>
              </li>
              <li className={styles.itemSubMenu}>
          ...
          <li className={styles.itemMenu}>
            ...
            <ul className={styles.subMenu}>
              <li className={styles.itemSubMenu}>
                <a className={styles.linkSubmenu} href="/listarAgendamento">
                  Listar Consultas
                </a>
              </li>
              <li className={styles.itemSubMenu}>
